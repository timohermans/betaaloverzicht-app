...
import { vi, describe, it, beforeEach, afterEach, expect, type Mock } from 'vitest';
		...
		describe('clicking budget progress text', () => {
			...
			describe('entering a new budget', () => {
				beforeEach(async () => {
					...
					await userEvent.type(screen.getByPlaceholderText('Wat is je budget?'), '250{enter}');
				});
	...
	describe('having a previously set budget', () => {
		...
		describe('clicking on the budget', () => {
			...
			describe('setting a new value', () => {
				...
				it('shows the updated value in text', async () => {
